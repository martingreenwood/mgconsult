...
const updateLogoColor = () => {
  ...
  // In light mode, determine color based on section
  const sections = [
...
// Watch for theme changes and update logo color
watch(isDark, () => {
  updateLogoColor()
})
  ...
  <main id="main-content" class="w-screen min-h-screen" :class="{ 'blur-sm': showModal || showLeftModal }" role="main">
    ...
    <section class="hero-section max-w-6xl mx-auto min-h-screen flex flex-col gap-8 justify-end"
      ...
      <div class="flex flex-row">
        <BaseButton variant="primary" size="lg" :has-arrow="true" @click="openModal"
