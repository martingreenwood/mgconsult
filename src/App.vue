    ...
    <footer id="site-footer" class="site-footer" role="contentinfo">
      <div class="max-w-6xl mx-auto px-6 md:px-8">
        <div class="footer-cta">
          <div class="max-w-2xl">
            <p class="footer-eyebrow">Senior technical partner</p>
            <h2 class="footer-cta-title">Bring calm ownership to the systems the business depends on.</h2>
          </div>
        ...
        <div class="footer-main">
          <div class="footer-brand">
            ...
            <p>
              Independent senior technical partner for businesses that need reliable digital systems, calm delivery,
          ...
          <div class="footer-column">
            ...
            <a href="/#services-heading">Retainer support</a>
          </div>
        </div>
