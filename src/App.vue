...
const updateLogoColor = () => {
  ...
  const sections = [
    ...
    { selector: '.showcase-section', color: '#fff' },
  ...
  for (const section of sections) {
    const elements = document.querySelectorAll<HTMLElement>(section.selector)
    ...
    <footer id="site-footer" class="site-footer" role="contentinfo">
      <div class="max-w-6xl mx-auto px-6 md:px-8">
        <div class="footer-cta">
          <div class="max-w-2xl">
            <p class="footer-eyebrow">Ready when the system is not</p>
            <h2 class="footer-cta-title">Let’s untangle the tech that is slowing the team down.</h2>
          </div>
          <div class="flex flex-col sm:flex-row gap-3 sm:items-center">
            <BaseButton variant="primary" size="md" :has-arrow="true" @click="openModal"
        ...
        <div class="footer-main">
          <div class="footer-brand">
            ...
            <p>
              Independent consultant developer for businesses that need reliable digital systems without the agency
              overhead.
            </p>
          </div>
          ...
          <nav class="footer-column" aria-label="Footer navigation">
            <h2>Explore</h2>
            <a href="/#services-heading">Services</a>
            <a href="/#projects-heading">Recent projects</a>
            <a href="/#approach-heading">Approach</a>
            <a href="/#trust-heading">Clients</a>
            <a href="/#faq-heading">FAQ</a>
            <a href="/downloads/rate-card.pdf" download>Rate card</a>
          </nav>

          <div class="footer-column">
            <h2>Common work</h2>
            <a href="/#services-heading">Systems integration</a>
            <a href="/#services-heading">Booking engines</a>
            <a href="/#services-heading">Laravel &amp; Vue apps</a>
            <a href="/#services-heading">Dashboards &amp; reporting</a>
            <a href="/#services-heading">Technical rescue</a>
          </div>
        ...
        <div class="footer-bottom">
          <p>&copy; {{ currentYear }} Neurospicy Studio Ltd trading as Martin Greenwood. All rights reserved.</p>
          <a href="https://martingreenwood.com" aria-label="Martin Greenwood homepage">martingreenwood.com</a>
        </div>
      </div>
    </footer>
  </main>
